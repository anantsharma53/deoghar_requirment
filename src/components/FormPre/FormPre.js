            ...
            <div className="applicant-details-container">
                ...
                <div className="header-section">
                    <div className="logo" >
                        ...
                        <p>
                            <strong>जिला देवघर  </strong>
                            <br></br>
                            <strong>DISTRICT DEOGHAR</strong>
                        </p>
                    </div>
                ...
                <table className="form-table">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <span>{values.draft_number}</span>
                            </td>
                            <td>
                                <span>{values.draft_date}</span>
                            </td>
                            <td>
                                <span>{values.dd_amount}</span>
                            </td>
                            <td>
                                <span>{values.bank_name}</span>
                            </td>
                        </tr>
                    </tbody>
                </table>
                <table className="form-table">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <span>{values.exp_circle}</span>
                            </td>
                            <td>
                                <span>{values.exp_police_station}</span>
                            </td>
                            <td>
                                <span>{values.exp_bit_number}</span>
                            </td>
                            <td>
                                <span>{values.exp_bit_village}</span>
                            </td>
                            <td>
                                <span>{values.exp_years}</span>
                            </td>
                            <td>
                                <span>{values.exp_remarks}</span>
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table className="form-table">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <span>{values.exam_center_name}</span>
                            </td>
                            <td>
                                <span>{values.exam_date}</span>
                            </td>
                            <td>
                                <span>{values.exam_time}</span>
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table className="form-table">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <span>{values.application_status}</span>
                            </td>
                            <td>
