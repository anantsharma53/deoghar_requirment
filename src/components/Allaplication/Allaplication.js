            ...
            <tbody>
              {applicants.map((applicant, index) => (
                <tr key={applicant.id}>
                  ...
                  <td className="tabledesign">{applicant.disability_percentage ? 'Yes' : 'No'}
                  <table className="insidetable">
                      <tbody>
                        
                          <tr >
                            <td><strong>Applicant Aisability</strong></td>
                            <td>{applicant.disability_percentage}</td>
                            <td>{applicant.disability_type}</td>
